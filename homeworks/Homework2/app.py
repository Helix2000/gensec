...
# Load a local JSON file, split it into chunks, and store it in the existing vector database.
def load_docs(docs):
...
def load_json(file_path):
    """Load a local JSON file and add it to the vector database."""
...
json_file = "./rag_data/json/data.json"
if os.path.exists(json_file):
    print(f"Loading JSON file: {json_file}")
    load_json(json_file)
else:
    print(f"JSON file not found: {json_file}. Add it to load JSON content into the database.")
